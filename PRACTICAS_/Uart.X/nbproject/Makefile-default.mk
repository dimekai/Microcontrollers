...
SOURCEFILES_QUOTED_IF_SPACED=principal.c LCD.s uart.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/principal.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/uart.o
POSSIBLE_DEPFILES=${OBJECTDIR}/principal.o.d ${OBJECTDIR}/LCD.o.d ${OBJECTDIR}/uart.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/principal.o ${OBJECTDIR}/LCD.o ${OBJECTDIR}/uart.o

# Source Files
SOURCEFILES=principal.c LCD.s uart.s
...
${OBJECTDIR}/uart.o: uart.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/uart.o.d 
	@${RM} ${OBJECTDIR}/uart.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  uart.s  -o ${OBJECTDIR}/uart.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,-MD,"${OBJECTDIR}/uart.o.d",--defsym=__MPLAB_BUILD=1,-g,--no-relax$(MP_EXTRA_AS_POST)
	@${FIXDEPS} "${OBJECTDIR}/uart.o.d"  $(SILENT)  -rsi ${MP_CC_DIR}../  
